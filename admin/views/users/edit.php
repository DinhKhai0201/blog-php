...
<div class="row row-offcanvas row-offcanvas-right" style="margin-top: 100px;">	
	<div class="col-xs-12 col-sm-9">
		...
		array('ctl'=>'users', 
			...
			<input type="hidden" value="<?php echo $value['birthday']?>" id = "birthday">
    <input type="hidden" value="<?php echo $value['hometown']?>" id = "hometown">
    <input type="hidden" value="<?php echo $value['gender']?>" id = "gender">
     <?php echo $this->error;?>
		  <div class="form-group">
		    <label for="firstname" class="col-sm-2 control-label">First Name (*)</label>
		    <div class="col-sm-10">
		      <input name="firstname" type="text" class="form-control" id="firstname" placeholder="firstname" value="<?php echo $value['firstname'];?>">
		    </div>
		  </div>
		  <div class="form-group">
		    <label for="address" class="col-sm-2 control-label">Email (*)</label>
		    <div class="col-sm-10">
		      <input name="email" type="text" class="form-control" id="address" placeholder="email" value="<?php echo $value['email'];?>">
		    </div>
		  </div>
		  <div class="form-group">
		    <label for="password" class="col-sm-2 control-label">Password (*)</label>
		    <div class="col-sm-10">
		      <input name="password" type="text" class="form-control" id="password" placeholder="password" value="<?php echo $value['password'];?>" >
		    </div>
		  </div>
		  <div class="form-group">
		    <label for="phonenumber" class="col-sm-2 control-label">Phone</label>
		    <div class="col-sm-10">
		      <input name="phonenumber" type="text" class="form-control" id="phonenumber" placeholder="phonenumber" value="<?php echo $value['phonenumber'];?>">
		    </div>
		  </div>
		   <div class="form-group">
            <label for="address" class="col-sm-2 control-label">Bio</label>
            <div class="col-sm-10">
                <textarea name="bio" class="form-control"><?php echo $value['bio']?> </textarea>
            </div>
         </div>
		  <div class="form-group">
		  ...
		  <div class="form-group">
		    ...
		    <div class="col-sm-10 image-upload">
		      ...
		      <img width="300px;" style = "border-radius: 114px;margin:10px;width: 205px;height: 204px;" src="<?php echo "../media/upload/profile/".(!empty($value['photo'])? $value['photo']: 'no_image.png'); ?>"  class="img-thumbnail">
		    </div>
		  </div>
		  <div class="form-group">
